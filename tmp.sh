...
python train_self_supervised.py -d reddit_10000 --use_memory --n_runs 1 --n_epoch 5 --bs 1000 --use_ef_iwf_weight --use_time_decay --ws_framework forward --custom_prefix tmp --ws_multiplier 1
