...
python train_self_supervised.py -d reddit_10000 --use_memory --n_runs 1 --n_epoch 5 --bs 200  --ws_framework forward --custom_prefix tmp --ws_multiplier 1 --init_n_instances_as_multiple_of_ws 5 --keep_last_n_window_as_window_slides 2 --window_stride_multiplier 1
